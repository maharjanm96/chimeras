...
const Footer = () => {
  return (
    <footer className="containerpx-4 lg:px-12 py-10 m-4  font-serif bg-accent-green/30 rounded-4xl">
      ...
      <div className="mt-10 pt-6 border-t border-black/5 flex flex-col md:flex-row gap-2 items-start md:items-center justify-between text-xs text-neutral-600 font-sans">
        <span>© {new Date().getFullYear()} Chimeras. All rights reserved.</span>
